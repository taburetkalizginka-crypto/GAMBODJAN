...
namespace schema {
    ...
    namespace C_DOTABaseAbility {
        constexpr std::uint16_t m_bHidden = 0x0617; // bool (1 bytes)
        constexpr std::uint16_t m_bActivated = 0x0619; // bool (1 bytes)
        constexpr std::uint16_t m_iLevel = 0x0628; // int32 (4 bytes)
        constexpr std::uint16_t m_fCooldown = 0x0638; // float32 (4 bytes) - GameTime when cd ends
        constexpr std::uint16_t m_flCooldownLength = 0x063C; // float32 (4 bytes)
        constexpr std::uint16_t m_iManaCost = 0x0640; // int32 (4 bytes)
        constexpr std::uint16_t m_bInIndefiniteCooldown = 0x0654; // bool (1 bytes)
        constexpr std::uint16_t m_nAbilityCurrentCharges = 0x0660; // int32 (4 bytes)
    }
