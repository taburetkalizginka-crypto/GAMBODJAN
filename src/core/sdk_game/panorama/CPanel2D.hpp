...
public:
	...
	std::string GetDisplayText( ) {
		...
		const char32_t* ptr = reinterpret_cast<const char32_t* ( __fastcall* )( CTextEntry* )>( global::patterns::CTextEntry__GetText )( this );
...
public:
	...
	void ShowErrorMessage( const char* content ) {
